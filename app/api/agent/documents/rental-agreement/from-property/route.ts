...
export async function POST(
  ...
  try {
    ...
    /*
     * Rental Agreement intentionally supports:
     *
     * - Bahasa Indonesia
     * - Bilingual Bahasa Indonesia + English
     *
     * English-only is not offered here.
     */
    const language:
    ...
    /*
     * Bahasa / bilingual documents should prefer
     * the Indonesian property title when available.
     */
    const propertyTitle =
      cleanText(
        property.title_id
    ...
    console.error(
      "Create rental agreement from property error:",
      error
    );
    ...
    return Response.json(
      {
        error:
          "Unable to create Rental Agreement from property.",
      },
      {
        status: 500,
      }
