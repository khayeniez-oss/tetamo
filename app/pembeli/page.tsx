  ...
  return (
    <div className="relative">
      <select
        ...
        required={required}
        className={[
          "w-full appearance-none rounded-2xl border border-gray-300 bg-white px-4 py-3 pr-11 text-sm outline-none focus:border-[#1C1C1E]",
          className,
        ].join(" ")}
      >
...
export default function PembeliPage() {
  ...
  const searchTypeOptions: SelectOption[] = [
    { value: "sale", label: lang === "id" ? "Dijual" : "For Sale" },
    { value: "rent", label: lang === "id" ? "Disewa" : "For Rent" },
    { value: "auction", label: lang === "id" ? "Lelang" : "Auction" },
  ];
  ...
  const propertyTypeOptions: SelectOption[] = [
    ...
    { value: "Ruko", label: lang === "id" ? "Ruko" : "Shop House" },
  ...
  const furnishedOptions: SelectOption[] = [
    {
      value: "Full Furnish",
      label: lang === "id" ? "Full Furnish" : "Fully Furnished",
    },
    {
      value: "Semi Furnish",
      label: lang === "id" ? "Semi Furnish" : "Semi Furnished",
    },
    {
      value: "Unfurnished",
      label: lang === "id" ? "Unfurnished" : "Unfurnished",
    },
  ];

  const certificateOptions: SelectOption[] = [
    {
      value: "SHM",
      label:
        lang === "id"
  ...
  const timelineOptions: SelectOption[] = [
    {
      value: "Secepatnya",
      label: lang === "id" ? "Secepatnya" : "As Soon As Possible",
    },
    {
      value: "Dalam 1 Bulan",
      label: lang === "id" ? "Dalam 1 Bulan" : "Within 1 Month",
    },
    {
      value: "Dalam 3 Bulan",
      label: lang === "id" ? "Dalam 3 Bulan" : "Within 3 Months",
    },
    {
      value: "Masih Survey",
      label: lang === "id" ? "Masih Survey" : "Just Browsing",
    },
  ];

  function updateField<K extends keyof BuyerForm>(
    key: K,
    value: BuyerForm[K]
  ) {
    setForm((prev) => ({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      console.error("Buyer request submit error:", error);
          ...
          {submitted ? (
            <div className="py-8">
              <div className="max-w-2xl">
                ...
                <h2 className="mt-5 text-2xl font-bold text-[#1C1C1E]">
                  {lang === "id"
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="mt-2 grid grid-cols-[120px_1fr] gap-2 md:grid-cols-[150px_1fr]">
                      <TetamoSelect
                        ...
                        onChange={(value) =>
                          updateField(
                            "countryCode",
                            value as BuyerForm["countryCode"]
                          )
                        }
                        options={COUNTRY_CODE_OPTIONS}
                        placeholder={lang === "id" ? "Kode" : "Code"}
                        required
                        className="py-3"
                      />
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-gray-300 px-4 py-3 text-sm outline-none focus:border-[#1C1C1E]"
                        required
                      />
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700">
                      {lang === "id" ? "Budget / Harga" : "Budget / Price"}
                    </label>
                    <input
                      type="text"
                      value={form.budget}
              ...
              <div>
                  ...
                  <div className="mt-3 flex items-center gap-6">
                    <label className="flex items-center gap-2 text-sm text-gray-700">
                      <input
                        ...
                        name="needAgent"
                        value="yes"
                        checked={form.needAgent === "yes"}
                        onChange={(e) =>
                          updateField("needAgent", e.target.value as "yes" | "no")
                        }
                      />
                      {lang === "id" ? "Ya" : "Yes"}
                    </label>
                ...
                <div className="mt-5">
                  ...
                  <textarea
                    ...
                    placeholder={
                      lang === "id"
                        ? "Contoh: dekat MRT, dekat sekolah, cocok untuk investasi, owner direct preferred, dll."
                        : "Example: near MRT, near school, suitable for investment, owner direct preferred, etc."
                    }
                    rows={5}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {lang === "id"
                        ...
                        : "Recommended agents are verified by TETAMO"}
                    </span>
                  </div>
                </div>
              </div>
