...
const CAMPAIGN_TYPES = [
  "Invite property owners to list",
  "Invite agents to join Tetamo",
  "Promote developer license",
  "Promote Tetamo marketplace",
  "Promote AI bilingual listing feature",
  "Promote direct WhatsApp inquiry",
  "Promote schedule viewing",
  "Promote verified listings",
  "General Tetamo brand awareness",
];
...
const DEFAULT_CAMPAIGN: CampaignInput = {
  campaignType: "Invite property owners to list",
  campaignGoal: "",
  targetAudience: "",
  keyMessage: "",
};
...
export default function AdminAiSocialPage() {
  ...
  const [tone, setTone] = useState<Tone>("Professional and friendly");
  ...
  async function loadProperties() {
    try {
      ...
      const { data, error: propertyError } = await supabase
        .from("properties")
        .select(
          "id, kode, title, price, city, area, listing_type, property_type, created_at"
        )
      ...
      console.error("Failed to load properties for AI social:", err);
  ...
  async function generateContent() {
    try {
      ...
      if (mode === "listing" && !selectedPropertyId) {
        setError("Please select a Tetamo listing first.");
        return;
      }

      const response = await fetch("/api/admin/ai-social", {
        method: "POST",
        headers: {
    ...
    <main className="space-y-5 text-[#1C1C1E]">
      ...
      <section className="grid gap-5 xl:grid-cols-[420px_minmax(0,1fr)]">
        <div className="space-y-5">
          <div className="rounded-[28px] border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
            ...
            <p className="mt-1 text-sm leading-6 text-gray-500">
              Choose whether AI should use a Tetamo listing, manual property
              details, or a campaign idea.
            </p>
            ...
            <div className="mt-4 grid grid-cols-1 gap-2">
              {[
                {
                  value: "listing",
                  label: "Existing Tetamo Listing",
                  text: "Use real listing data from Supabase.",
                },
                {
                  value: "manual",
        ...
        <div className="space-y-5">
          ...
          {mode === "campaign" ? (
            <div className="rounded-[28px] border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
              <h2 className="text-base font-bold">Tetamo Campaign Details</h2>
              <p className="mt-1 text-sm leading-6 text-gray-500">
                Generate marketing content for Tetamo campaigns, owners, agents,
                developers, and marketplace promotion.
              </p>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <InputField
                  ...
                  placeholder="Owners, agents, developers, buyers, renters..."
                />
              </div>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4">
                <TextAreaField
                  ...
                  placeholder="Example: Encourage property owners to list on Tetamo and understand why clearer listings help inquiries."
                />
                ...
                <TextAreaField
                  ...
                  placeholder="Example: Tetamo helps owners and agents create clearer, more transparent listings with AI bilingual content, direct WhatsApp inquiry, and schedule viewing."
                />
              </div>
            </div>
          ) : null}
