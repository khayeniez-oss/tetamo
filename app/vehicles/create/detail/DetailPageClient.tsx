...
export default function DetailPageClient() {
  ...
  const initialYearSelection = isPreset(
    String(draft?.year || ""),
    yearOptions
  )
    ? String(draft?.year || "")
              ...
              <div>
                ...
                {brandSelection === SELECT_OTHER ? (
                  <input
                    ...
                    placeholder={
                      lang === "id" ? "Ketik brand manual" : "Type brand manually"
                    }
                    className={inputBase}
                  />
                ) : null}
              ...
              <div>
                ...
                {modelSelection === SELECT_OTHER ? (
                  <input
                    ...
                    placeholder={
                      lang === "id" ? "Ketik model manual" : "Type model manually"
                    }
                    className={inputBase}
                  />
                ) : null}
              ...
              <div>
                ...
                {variantSelection === SELECT_OTHER ? (
                  <input
                    ...
                    placeholder={
                      lang === "id" ? "Ketik varian manual" : "Type variant manually"
                    }
                    className={inputBase}
                  />
                ) : null}
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    lang === "id" ? "Contoh: 350000000" : "Example: 350000000"
                  }
                  className={inputBase}
                />
              </div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <div className="mt-2">
                  <TetamoSelect
                    value={transmission}
                    placeholder={
                      lang === "id" ? "Pilih transmisi" : "Select transmission"
                    }
              ...
              <div>
                ...
                <div className="mt-2">
                  <TetamoSelect
                    value={fuel}
                    placeholder={lang === "id" ? "Pilih bahan bakar" : "Select fuel"}
              ...
              <div>
                ...
                <div className="mt-2">
                  <TetamoSelect
                    ...
                    placeholder={lang === "id" ? "Pilih mesin" : "Select engine"}
              ...
              <div>
                ...
                <div className="mt-2">
                  <TetamoSelect
                    value={condition}
                    placeholder={
                      lang === "id" ? "Pilih kondisi" : "Select condition"
                    }
