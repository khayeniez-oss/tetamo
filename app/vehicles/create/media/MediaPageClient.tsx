...
export default function MediaPageClient() {
  ...
  const t =
    lang === "id"
      ? {
          ...
          pageTitle:
            vehicleType === "motor"
              ? "Upload Foto & Video Motor"
              : "Upload Foto & Video Mobil",
          pageSubtitle:
            vehicleType === "motor"
              ? "Lengkapi foto, video, judul, dan deskripsi agar listing motor tampil lebih jelas dan menarik."
              : "Lengkapi foto, video, judul, dan deskripsi agar listing mobil tampil lebih jelas dan menarik.",
      ...
      : {
          ...
          pageTitle:
            vehicleType === "motor"
              ? "Upload Motorbike Photos & Video"
              : "Upload Car Photos & Video",
          pageSubtitle:
            vehicleType === "motor"
              ? "Complete the photos, video, title, and description so the motorbike listing looks clearer and more attractive."
              : "Complete the photos, video, title, and description so the car listing looks clearer and more attractive.",
  ...
  const photoInputId = "vehicle-photo-input";
  const videoInputId = "vehicle-video-input";
  ...
  function handleNext() {
    ...
    router.push(`/vehicles/create/verification?plan=${currentPlan}`);
  }
