...
import { TERMS_SECTIONS, type TermsSection } from "../data/terms-content";
...
export default function TermsAndConditionsPage() {
  ...
  const [sections, setSections] = useState<TermsSection[]>(TERMS_SECTIONS);
  ...
  const t = {
    ...
    subtitle: isID
      ? "Silakan baca setiap bagian di bawah ini dengan saksama sebelum menggunakan platform TeTaMo."
      : "Please read each section below carefully before using the TeTaMo platform.",
    ...
    quickOverviewText: isID
      ? "Klik setiap bagian untuk membuka isi syarat dan ketentuan."
      : "Click each section to open the contents of the terms and conditions.",
    ...
    stillNeedHelpText: isID
      ? "Jika Anda membutuhkan bantuan lebih lanjut mengenai syarat penggunaan platform, silakan hubungi kami."
      : "If you need further help regarding the platform terms of use, please contact us.",
              ...
              >
                ...
                {isOpen && (
                  <div className="border-t border-gray-100 px-6 pb-6 pt-5">
                    <div className="rounded-[24px] bg-gray-50 px-5 py-5 text-[15px] leading-8 text-gray-700 whitespace-pre-line md:text-[16px]">
